...
/***/ function(module, exports, __webpack_require__) {
	...
	var forceManyBody = d3.forceManyBody().strength(-50) // repulsion between nodes
	...
	var simulation = d3.forceSimulation().force("link", forceLink).force("charge", forceManyBody).force("center", forceCenter);

	// node dragging starts

	var dragStarts = function dragStarts(d) {
	...
	var dragEnds = function dragEnds(d) {
	...
	// Tooltip container
	var tooltipBox = d3.select(".chart").append("div");

	// tooltip
	var toolTip = function toolTip(d) {
		tooltipBox.style("opacity", 1).html(d.country).style("left", d3.event.pageX - 160 + 'px').style("top", d3.event.pageY - 120 + 'px');
	};

	// data renders to svg

	var render = function render(err, data) {
		if (err) throw err; // throws error

		// Links - svg line

		var link = svg.append("g").attr("class", "links").selectAll("line").data(data.links).enter().append("line").attr("stroke", "white").attr("stroke-width", 1);

		// Nodes


		var node = d3.select('.chart').selectAll("img").data(data.nodes).enter().append("img").attr("class", function (d) {
		...
		node.call(d3.drag().on("start", dragStarts).on("drag", dragging).on("end", dragEnds));

		// setting our data (nodes) as simulation nodes
		simulation.nodes(data.nodes).on("tick", tick); // tick is listening
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, "* {\n  box-sizing: border-box; }\n\nbody {\n  background: #51634c;\n  padding: 0;\n  margin: 0; }\n\n.chart {\n  height: 700px;\n  width: 1000px;\n  margin: 10px auto;\n  position: relative; }\n  .chart svg {\n    background: #1d2327;\n    box-shadow: 6px 6px 10px #25213c;\n    border-radius: 5px; }\n  .chart img {\n    position: absolute; }\n  .chart div {\n    position: absolute;\n    z-index: 1;\n    background: white;\n    color: black;\n    padding: 3px;\n    border-radius: 5px;\n    opacity: 0; }\n\nh1 {\n  text-align: center;\n  color: white; }\n", ""]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		// When the styles change, update the <style> tags
		if(!content.locals) {
			module.hot.accept("!!./../../node_modules/css-loader/index.js!./../../node_modules/sass-loader/index.js!./flags.css", function() {
				var newContent = require("!!./../../node_modules/css-loader/index.js!./../../node_modules/sass-loader/index.js!./flags.css");
				if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
				update(newContent);
			});
		}
